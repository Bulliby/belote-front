<template>
  <div class="suit">
    <svg style="display: none;">
      <symbol id="suit-clubs" viewBox="0 0 45.33 50.5" fill="black" class="text-white">
      ...
      <symbol id="suit-diamonds" viewBox="0 0 45.33 50.5" fill="red" class="text-red">
      ...
      <symbol id="suit-hearts" viewBox="0 0 45.33 50.5" fill="red" class="text-red">
      ...
      <symbol id="suit-spades" viewBox="0 0 45.33 50.5" fill="black" class="text-white">
